...
import { loadVoiceId } from './lib/voiceStorage'

function App() {
  const [screen, setScreen] = useState<'home' | 'read'>('home')
  const [text, setText] = useState('')
  const [voiceId] = useState(() => loadVoiceId())
  ...
  return (
    <div className="box-border flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden bg-ios-bg text-[14px] leading-normal text-ios-label">
      <div
